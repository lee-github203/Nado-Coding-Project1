...
// 물고기가 6마리가 있음
// 물고기들이 어항에 살고 있는데 사막임
// 사막이 너무 덥고, 건조해서 물이 빨리 증발함
// 물이 다 증발하기 전에 부리전히 어항에 물을 줘서 물고기를 살려라
...
int main_pointer_project(void)
{
	...
	while (1)
	{
		...
		// 사용자가 입력한 어항에 물을 준다
		// 1. 어항의물이 0 이면? 물을 주지 않는다... 이미 물고기 뒤짐
		if (cursor[num] - 1 <= 0)
		{
		...
		// 레벨업을 할 건지 확인 (레벨업을 20초마다 한 번씩 수행)
